...
class SecuredInstallment extends Base {
	/**
	...
	public function __construct( $gateway ) {
		...
		$this->set( 'workorderid', $_POST['payone_secured_installment_workorderid'] );
		$this->set( 'add_paydata[installment_option_id]', $_POST['payone_secured_installment_option'] );
		$this->set( 'add_paydata[device_token]', $_POST['payone_secured_installment_token'] );
		$this->set( 'birthday', Base::convert_birthday( $_POST['payone_secured_installment_birthday'] ) );
		$this->set( 'iban', $_POST['payone_secured_installment_iban'] );
