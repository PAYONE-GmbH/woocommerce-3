...
class Plugin {
	...
	public function init() {
		...
		foreach ( $gateway_id_gateway_map as $gateway ) {
	...
	public static function get_transaction_for_gateway( GatewayBase $gateway ) {
		...
		if ( array_key_exists( $gateway_class, $gateway_transaction_map ) ) {
			$transaction_class = $gateway_transaction_map[ $gateway_class ];
