...
/***/ "./client/blocks/amazonpay/express.jsx":
/*!*********************************************!*\
  !*** ./client/blocks/amazonpay/express.jsx ***!
  \*********************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
var AmazonPayExpressButton = function AmazonPayExpressButton(_ref) {
  ...
  var _wc$wcSettings$getSet = wc.wcSettings.getSetting('payone_data'),
    amazonPayConfig = _wc$wcSettings$getSet.amazonPayConfig;
  ...
  var _useState = (0, _element.useState)(null),
    ...
    workorderId = _useState2[0],
    setWorkorderId = _useState2[1];
  ...
  (0, _element.useEffect)(function () {
    // Load Amazon SDK
    _AssetService.default.loadJsScript(amazonPayConfig.sdkUrl, function () {
      ...
      fetch(amazonPayConfig.createSessionExpressUrl, {
        ...
        setErrorMessage((0, _i18n.__)('Failed to initialize AmazonPay Express. Please try again.', 'payone-woocommerce-3'));
        setIsReady(false);
      });
    });
  }, []);
    ...
    return onPaymentSetup(function () {
      if (!isReady || !workorderId) {
        return {
          ...
          message: (0, _i18n.__)('AmazonPay Express is not ready. Please try again.', 'payone-woocommerce-3')
        };
      }
      return {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "payone-amazonpay-express-container"
  }, errorMessage && /*#__PURE__*/React.createElement("div", {
    id: "amazonpay_express_error",
    style: {
      color: 'red',
      marginTop: '10px'
    }
  }, errorMessage), !errorMessage && /*#__PURE__*/React.createElement("div", {
    id: "payone-amazonpay-express-button"
  }));
};
var _default = exports["default"] = (0, _getPaymentMethodConfig.default)('payone_amazonpay_express', (0, _i18n.__)('PAYONE Amazon Pay Express', 'payone-woocommerce-3'), "".concat(_constants.PAYONE_ASSETS_URL, "/icon-amazon-pay.png"), /*#__PURE__*/React.createElement(AmazonPayExpressButton, null), {
  ...
  canMakePayment: function canMakePayment() {
    var _wc$wcSettings$getSet2 = wc.wcSettings.getSetting('payone_data'),
      amazonPayConfig = _wc$wcSettings$getSet2.amazonPayConfig;
...
/***/ "./client/blocks/amazonpay/index.jsx":
/*!*******************************************!*\
  !*** ./client/blocks/amazonpay/index.jsx ***!
  \*******************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
function _iterableToArrayLimit(r, l) { var t = null == r ? null : "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (null != t) { var e, n, i, u, a = [], f = !0, o = !1; try { if (i = (t = t.call(r)).next, 0 === l) { if (Object(t) !== t) return; f = !1; } else for (; !(f = (e = i.call(t)).done) && (a.push(e.value), a.length !== l); f = !0); } catch (r) { o = !0, n = r; } finally { try { if (!f && null != t.return && (u = t.return(), Object(u) !== u)) return; } finally { if (o) throw n; } } return a; } }
function _arrayWithHoles(r) { if (Array.isArray(r)) return r; }
var AmazonPayButton = function AmazonPayButton(_ref) {
  var eventRegistration = _ref.eventRegistration,
    emitResponse = _ref.emitResponse;
  var _wc$wcSettings$getSet = wc.wcSettings.getSetting('payone_data'),
    amazonPayConfig = _wc$wcSettings$getSet.amazonPayConfig;
  ...
  var buttonRef = (0, _element.useRef)(null);
  var wrapperRef = (0, _element.useRef)(null);
  var amazonButtonInstance = (0, _element.useRef)(null);
  (0, _element.useEffect)(function () {
    // Load Amazon SDK
    _AssetService.default.loadJsScript(amazonPayConfig.sdkUrl, function () {
      ...
      fetch(amazonPayConfig.createSessionUrl, {
        ...
        if (typeof amazon !== 'undefined' && amazon.Pay) {
          ...
          amazonButtonInstance.current = amazon.Pay.renderButton('#payone-amazonpay-button', {
            merchantId: config.merchantId,
            publicKeyId: config.publicKeyId,
            ledgerCurrency: config.ledgerCurrency,
            checkoutLanguage: config.checkoutLanguage,
          ...
          amazonButtonInstance.current.onClick(function () {
        ...
        setErrorMessage((0, _i18n.__)('Failed to initialize AmazonPay. Please try again.', 'payone-woocommerce-3'));
        setIsReady(false);
      });
    });
  }, []);
  ...
  (0, _element.useEffect)(function () {
    return onPaymentSetup(function () {
      if (!isReady || !workorderId) {
        return {
          type: responseTypes.ERROR,
          message: (0, _i18n.__)('AmazonPay is not ready. Please try again.', 'payone-woocommerce-3')
        };
      }
      ...
      if (!shippingAddress.phone || shippingAddress.phone.trim() === '') {
        return {
          type: responseTypes.ERROR,
          message: (0, _i18n.__)('A phone number is required for Amazon Pay. Please add a phone number to your shipping address.', 'payone-woocommerce-3')
        };
      }
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "payone-amazonpay-container"
  }, /*#__PURE__*/React.createElement("p", null, amazonPayConfig.description || ''), errorMessage && /*#__PURE__*/React.createElement("div", {
    id: "amazonpay_error",
    style: {
      color: 'red',
      marginTop: '10px'
    ...
    style: {
      ...
      pointerEvents: 'none',
      // Prevent accidental user clicks
      opacity: 0
    }
  })));
};
var _default = exports["default"] = (0, _getPaymentMethodConfig.default)('payone_amazonpay', (0, _i18n.__)('PAYONE Amazon Pay', 'payone-woocommerce-3'), "".concat(_constants.PAYONE_ASSETS_URL, "/icon-amazon-pay.png"), /*#__PURE__*/React.createElement(AmazonPayButton, null), {
  canMakePayment: function canMakePayment() {
    var _wc$wcSettings$getSet2 = wc.wcSettings.getSetting('payone_data'),
      amazonPayConfig = _wc$wcSettings$getSet2.amazonPayConfig;
  ...
  (0, _element.useEffect)(function () {
    window.addEventListener('creditCardCheckCallbackEvent', function (_ref2) {
      ...
      if (detail.status === 'VALID') {
        var _cardHolderInput$curr;
        setPayoneCheckSucceeded(true);
        setPaymentMethodData({
          card_holder: ((_cardHolderInput$curr = cardHolderInput.current) === null || _cardHolderInput$curr === void 0 ? void 0 : _cardHolderInput$curr.value) || '',
...
var _getPaymentMethodConfig = _interopRequireDefault(__webpack_require__(/*! ../../services/getPaymentMethodConfig */ "./client/services/getPaymentMethodConfig.js"));
var _shippingAddressValidator = __webpack_require__(/*! ../../services/shippingAddressValidator */ "./client/services/shippingAddressValidator.js");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _slicedToArray(r, e) { return _arrayWithHoles(r) || _iterableToArrayLimit(r, e) || _unsupportedIterableToArray(r, e) || _nonIterableRest(); }
function _nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _unsupportedIterableToArray(r, a) { if (r) { if ("string" == typeof r) return _arrayLikeToArray(r, a); var t = {}.toString.call(r).slice(8, -1); return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? _arrayLikeToArray(r, a) : void 0; } }
...
function _iterableToArrayLimit(r, l) { var t = null == r ? null : "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (null != t) { var e, n, i, u, a = [], f = !0, o = !1; try { if (i = (t = t.call(r)).next, 0 === l) { if (Object(t) !== t) return; f = !1; } else for (; !(f = (e = i.call(t)).done) && (a.push(e.value), a.length !== l); f = !0); } catch (r) { o = !0, n = r; } finally { try { if (!f && null != t.return && (u = t.return(), Object(u) !== u)) return; } finally { if (o) throw n; } } return a; } }
function _arrayWithHoles(r) { if (Array.isArray(r)) return r; }
var _canMakePayment = (0, _shippingAddressValidator.createShippingAddressValidator)('paylaConfig');
...
var _default = exports["default"] = (0, _getPaymentMethodConfig.default)('payone_secured_direct_debit', (0, _i18n.__)('PAYONE Secured Direct Debit', 'payone-woocommerce-3'), "".concat(_constants.PAYONE_ASSETS_URL, "/icon-secured-lastschrift.png"), /*#__PURE__*/React.createElement(PaylaSecuredDirectDebit, null), {
  canMakePayment: function canMakePayment() {
    return _canMakePayment('payone_secured_direct_debit');
  }
});
...
var _default = exports["default"] = (0, _getPaymentMethodConfig.default)('payone_secured_installment', (0, _i18n.__)('PAYONE Secured Installment', 'payone-woocommerce-3'), "".concat(_constants.PAYONE_ASSETS_URL, "/icon-rechnungskauf.png"), /*#__PURE__*/React.createElement(PaylaSecuredInstallment, null), {
  canMakePayment: function canMakePayment() {
    return _canMakePayment('payone_secured_installment');
  }
});
...
var _default = exports["default"] = {
  ...
  canMakePayment: function canMakePayment() {
    return _canMakePayment(PAYMENT_METHOD_NAME);
  },
  paymentMethodId: PAYMENT_METHOD_NAME,
  supports: {
    showSavedCards: false,
...
var _canMakePayment = (0, _shippingAddressValidator.createShippingAddressValidator)('ratepayConfig');
...
var getPluginUrl = function getPluginUrl() {
  if (typeof window.wc !== 'undefined' && window.wc.wcSettings) {
    var payoneData = window.wc.wcSettings.getSetting('payone_data', {});
...
var PAYONE_PLUGIN_URL = exports.PAYONE_PLUGIN_URL = getPluginUrl();
var PAYONE_ASSETS_URL = exports.PAYONE_ASSETS_URL = "".concat(PAYONE_PLUGIN_URL, "/assets");
...
/***/ "./client/services/shippingAddressValidator.js":
/*!*****************************************************!*\
  !*** ./client/services/shippingAddressValidator.js ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
exports.createShippingAddressValidator = createShippingAddressValidator;
var _data = __webpack_require__(/*! @wordpress/data */ "@wordpress/data");
 ...
 * };
 */
function createShippingAddressValidator(configKey) {
  return function canMakePayment(gatewayId) {
    var payoneData = wc.wcSettings.getSetting('payone_data');
    var config = payoneData[configKey];
    if (!config || !config.allowDifferentShippingAddress) {
      return true;
    }
    var allowDifferentShippingAddress = config.allowDifferentShippingAddress[gatewayId];
    ...
    var _store$getCartData = store.getCartData(),
      billingAddress = _store$getCartData.billingAddress,
      shippingAddress = _store$getCartData.shippingAddress;
    var relevantFields = ['first_name', 'last_name', 'company', 'address_1', 'address_2', 'city', 'postcode', 'country'];
    var billingData = {};
    var shippingData = {};
    ...
    return (0, _isShallowEqual.default)(billingData, shippingData);
  };
}
...
var _amazonpay = _interopRequireDefault(__webpack_require__(/*! ./amazonpay */ "./client/blocks/amazonpay/index.jsx"));
var _express = _interopRequireDefault(__webpack_require__(/*! ./amazonpay/express */ "./client/blocks/amazonpay/express.jsx"));
...
var _express2 = _interopRequireDefault(__webpack_require__(/*! ./paypalv2/express */ "./client/blocks/paypalv2/express.jsx"));
...
var _sofort = _interopRequireDefault(__webpack_require__(/*! ./klarna/sofort */ "./client/blocks/klarna/sofort.jsx"));
...
(0, _blocksRegistry.registerPaymentMethod)(_amazonpay.default);
...
(0, _blocksRegistry.registerExpressPaymentMethod)(_express2.default);
